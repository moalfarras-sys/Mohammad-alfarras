...
const fallbackConfigs = {
  ...
  moplayer2: {
    ...
    maintenanceMode: false,
    forceUpdate: false,
    minimumVersionCode: 47,
    latestVersionName: "2.5.9",
    ...
    update: {
      ...
      apkSizeBytes: 49251129,
      checksumSha256: "b1eadf0cbba9567748f6421d84c5de84172f9f155dba2543eb9ec06a52e01b02",
      releaseNotes: "MoPlayer Pro 2.5.9 fixes QR source delivery, keeps each server local to the device, resets stale local library cache after update, reloads Live/VOD/Series from the saved source, and improves poster handling for large Xtream and M3U libraries.",
    },
