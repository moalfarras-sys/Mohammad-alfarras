...
const fallbackProduct: AppProduct = {
  ...
  compatibility_notes: [
    ...
    "Primary release channel targets arm64-v8a devices",
  ],
  legal_notes: [
...
const fallbackReleases: AppRelease[] = [
  {
    ...
    compatibility_notes: "Recommended for arm64-v8a devices. Secondary armeabi-v7a build is also available.",
    published_at: now,
    is_published: true,
    created_at: now,
    updated_at: now,
    assets: [
      {
        ...
        storage_bucket: null,
        storage_path: null,
        external_url: "https://ckefrnalgnbuaxsuufyx.supabase.co/storage/v1/object/public/app-releases/moplayer/2.0.0/app-sideload-arm64-v8a-release.apk",
        mime_type: "application/vnd.android.package-archive",
        file_size_bytes: 51925872,
        checksum_sha256: "62781a44a2a2424b8a1c8457a91e17af3c904d361157639b10058e350a5bc65e",
        is_primary: true,
        created_at: now,
      },
      {
        ...
        release_id: "release-v2-0-0",
        asset_type: "apk",
        label: "armeabi-v7a build",
        abi: "armeabi-v7a",
        storage_bucket: null,
        storage_path: null,
        external_url: "https://ckefrnalgnbuaxsuufyx.supabase.co/storage/v1/object/public/app-releases/moplayer/2.0.0/app-sideload-armeabi-v7a-release.apk",
        mime_type: "application/vnd.android.package-archive",
        file_size_bytes: 47874576,
        checksum_sha256: "b01facd268a360c4c78578d067d58e7dd1c82f1277df0691b350b21016fc6d8b",
        is_primary: false,
        created_at: now,
      },
    ],
