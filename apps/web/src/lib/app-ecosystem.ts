...
const fallbackProduct: AppProduct = {
  ...
  logo_path: "/images/moplayer-brand-logo.png",
  hero_image_path: "/images/moplayer-brand-glow-card.png",
  tv_banner_path: "/images/moplayer-brand-glow-card.png",
  status: "published",
  last_updated_at: now,
  created_at: now,
  updated_at: now,
...
const fallbackScreenshots: AppScreenshot[] = [
  {
    ...
    image_path: "/images/moplayer_ui_now_playing.png",
    device_frame: "phone",
    sort_order: 1,
    is_featured: true,
    created_at: now,
  },
  {
    ...
    image_path: "/images/moplayer_ui_playlist.png",
    device_frame: "phone",
    sort_order: 2,
    is_featured: false,
    created_at: now,
  },
  {
    ...
    image_path: "/images/moplayer-tv-banner.png",
    device_frame: "tv",
    sort_order: 3,
    is_featured: false,
    created_at: now,
