...
/* ─────────────────────────────────────────────────────────────────────────────
 *  FORGE Copy — Agency-level. Magnetic. Authentic. Converts.
 *  Arabic: bold, poetic, direct — speaks to the client's desire.
 *  English: punchy, cinematic, confident — not corporate, not cliché.
 * ─────────────────────────────────────────────────────────────────────────── */
...
function localeCopy(locale: Locale) {
  if (locale === "ar") {
    return {
      home: {
        eyebrow: "مطوّر · مصمم · صانع محتوى تقني عربي",
        titleLead: "لا أصمّم مواقع.",
        titleAccent: "أصمّم انطباعات أولى",
        titleTail: " تحوّل الزائر إلى عميل.",
        body:
          "محمد الفراس — مطوّر ويب وصانع منتجات رقمية من الحسكة، مقيم في ألمانيا. ستة أعوام من الكود الحقيقي، ومليون ونصف مشاهدة عربية، وتطبيق Android يُستخدم الآن. كل ما تراه هنا لم يُعلَّق على الحائط — بُني ليُستخدَم.",
        primary: "شوف الأعمال",
        secondary: "السيرة الذاتية",
        quickEyebrow: "في جوهره",
        quickTitle: "بعض الناس يتحدثون عن التميّز. أنا أذهب إلى النوم بعد أن أُثبته.",
        strengthsEyebrow: "لماذا يختارني العملاء",
        strengths: [
          {
            title: "واجهات تُقنع قبل أن تُعجب",
            body: "ما عندي واجهة تبدو جميلة وتفشل في الإقناع. كل صفحة أبنيها مبنية لهدف — تسجيل، شراء، تواصل، أو ثقة. الجمال البصري يخدم الهدف، لا يحجبه.",
          },
          {
            title: "خبرة تشغيلية حقيقية خلف كل قرار",
            body: "عشر سنوات وراء عمليات لوجستية تحت ضغط يومي علّمتني شيئاً لا تعلّمه الكورسات: التسليم في الوقت، وحل المشكلة قبل أن يراها العميل.",
          },
          {
            title: "+1.5 مليون مشاهدة عربية — ليست صدفة",
            body: "القناة ليست 'مشروعاً جانبياً'. هي دليل على أن العربي يستحق محتوى تقنياً يحترم ذكاءه. والأرقام لا تكذب.",
          },
        ],
        statsEyebrow: "أرقام لا تحتاج تعليقاً",
        stats: [
          { value: "1.5M+", label: "مشاهدة على يوتيوب" },
          { value: "6+", label: "سنوات كود ولوجستيات حقيقية" },
          { value: "AR · EN · DE", label: "ثلاث لغات عمل" },
          { value: "🇩🇪 🇸🇾", label: "ألمانيا — والحسكة بالقلب" },
        ],
        philosophyEyebrow: "الفلسفة التي تحكم كل سطر كود",
        philosophyQuote: "موقع لا يفهمه الزائر في 8 ثوانٍ — يحتاج إعادة تصميم، لا إعادة تلوين.",
        philosophyPoints: [
          "أرفض مشاريع لا تخدم هدفاً حقيقياً — لأن وقتك ووقتي أغلى من ذلك.",
          "السرعة والأداء ليسا ترفاً تقنياً — هما الاحترام الأول للزائر.",
          "تصميم بدون استراتيجية هو مجرد زخرفة مكلّفة.",
          "منتج واحد مكتمل ومدروس أفضل ألف مرة من مشاريع نصف منجزة.",
        ],
        workEyebrow: "أعمال مختارة — شوف بنفسك",
        workTitle: "أتحدى أي موقع أبنيته ألا يجعلك تريد ما بنيه.",
        workBody: "دراسات حالة أمينة: ما كان التحدي، كيف قررنا، وما النتيجة القابلة للقياس.",
        productEyebrow: "المنتج الرائد",
        productTitle: "MoPlayer — تطبيق بنيته من الصفر. وما زلت أطوّره.",
        productBody:
          "Android و Android TV. بدون إعلانات. بدون تتبع. بدون جدران مدفوعة مخفية. إصدارات منتظمة، دعم حقيقي، وهوية بصرية متماسكة. هذا ما يعنيه بناء منتج باحترام.",
        productPrimary: "صفحة المنتج",
        productSecondary: "دراسة الحالة",
        servicesEyebrow: "ماذا أبني لك",
        servicesTitle: "لا أقبل كل المشاريع. ما أقبله — أُتقنه.",
        services: [
          { title: "موقع شخصي أو تجاري يبيع", body: "ليس 'موقع بروشور'. موقع يُقنع الزائر — سريع الأداء، متعدد اللغات، ببنية قابلة للنمو. ما يشعّرك بالحرج أمام عميلك." },
          { title: "صفحة إطلاق تُقنع في 60 ثانية", body: "عرض الفايدة الرئيسية، بناء الثقة، ودفع الزائر نحو الفعل — قبل أن يضغط 'رجوع'. هذا هو الهدف الوحيد للصفحة." },
          { title: "تطبيق Android بهوية كاملة", body: "كود نظيف، واجهة مدروسة، ومتابعة ما بعد الإطلاق. MoPlayer هو السيرة الذاتية الحية لهذا." },
          { title: "محتوى يوتيوب يثق به الجمهور", body: "محتوى تقني يشرح منتجك بصدق ويبني جمهوراً يشتري لأنه يثق — أكثر قيمة بألف مرة من إعلان مدفوع وينتهي بانتهاء الميزانية." },
        ],
        mediaEyebrow: "يوتيوب — المحتوى العربي التقني بمعيار مختلف",
        mediaTitle: "مليون ونصف مشاهدة تثبت أن المحتوى الجيد يُشاهَد بأي لغة.",
        mediaPrimary: "اذهب إلى القناة",
        contactEyebrow: "ابدأ المشروع",
        contactTitle: "فكرتك تستحق من يبنيها بشكل صحيح — أرسلها الآن.",
        contactBody:
          "لا تحتاج ملفاً جاهزاً أو مواصفات محددة. أخبرني بما تريد تحقيقه، وسأقترح الطريق الأوضح. أعمل مع المشاريع الجادة التي تريد نتيجة حقيقية.",
  ...
  return {
    home: {
      eyebrow: "Developer · Product Builder · Arabic Tech Creator",
      titleLead: "I don't just build websites.",
      titleAccent: "I engineer first impressions",
      titleTail: " that turn clicks into clients.",
      body:
        "Mohammad Alfarras — web developer and product builder from Al-Hasakah, now based in Germany. Six years of shipped code, 1.5M Arabic tech views, and a live Android app used daily. Not a single thing here is theoretical.",
      primary: "See the work",
      secondary: "View CV",
      quickEyebrow: "At the core",
      quickTitle: "Some people talk about excellence. I go to sleep after I've proven it.",
      strengthsEyebrow: "Why clients choose me",
      strengths: [
        {
          title: "Interfaces that persuade before they impress",
          body: "Every screen I ship is wired to a goal — sign up, buy, trust, contact. Aesthetics serve the objective. Never the other way around.",
        },
        {
          title: "Real operational discipline behind every decision",
          body: "A decade in logistics under daily pressure taught me what no bootcamp teaches: ship on time, solve the problem before the client sees it. That's visible in every project.",
        },
        {
          title: "1.5M Arabic views — built with the same rigour as this website",
          body: "The channel isn't a hobby. It's proof that Arabic technical content can compete globally. The audience comes back because the quality is consistent.",
        },
      ],
      statsEyebrow: "Numbers that don't need context",
      stats: [
        { value: "1.5M+", label: "YouTube views" },
        { value: "6+", label: "Years: real code & real ops" },
        { value: "AR · EN · DE", label: "Three working languages" },
        { value: "🇩🇪 🇸🇾", label: "Germany — Al-Hasakah at heart" },
      ],
      philosophyEyebrow: "The principles that govern every line of code",
      philosophyQuote: "A page the visitor can't grasp in 8 seconds needs a redesign — not a new color.",
      philosophyPoints: [
        "I decline projects with no clear objective — your time and mine are worth more than that.",
        "Performance and speed aren't technical luxuries — they're the basic respect a page owes its visitor.",
        "Design without strategy is premium-priced decoration.",
        "One complete, well-considered product beats five half-built experiments. Always.",
      ],
      workEyebrow: "Selected work — judge for yourself",
      workTitle: "Every project here was a real problem that became a real solution.",
      workBody: "Honest case studies: what the challenge was, how we decided, and what measurably changed after launch.",
      productEyebrow: "Lead product",
      productTitle: "MoPlayer — built from zero. Still being built.",
      productBody:
        "Android + Android TV. No ads. No tracking. No hidden paywalls. Regular releases, real support, and a brand identity that's coherent across every screen. This is what building a product with respect looks like.",
      productPrimary: "Product page",
      productSecondary: "Case study",
      servicesEyebrow: "What I build for you",
      servicesTitle: "Not every project gets a yes. What gets a yes — gets mastered.",
      services: [
        { title: "A website that sells", body: "Not a brochure. A multilingual, fast, precision-built presence that converts. Nothing you'd be embarrassed to show a high-value client." },
        { title: "A launch page that closes in 60s", body: "Lead the value, build the trust, push the action — before the visitor hits back. One page that earns its keep." },
        { title: "An Android app with a real identity", body: "Clean architecture, a considered UI, and post-launch attention. MoPlayer is the living proof of what I mean."},
        { title: "YouTube content that builds trust", body: "Honest product storytelling that builds an audience ready to buy — worth more than any ad budget that goes dark the moment you stop paying." },
      ],
      mediaEyebrow: "YouTube · Arabic tech at a different standard",
      mediaTitle: "1.5 million views. Proof that good content finds its audience in any language.",
      mediaPrimary: "Open the channel",
      contactEyebrow: "Start the project",
      contactTitle: "Your idea deserves to be built right. Send it now.",
      contactBody:
        "No formal brief needed. Tell me what you want to achieve and I'll propose the clearest path. I work with founders, small teams, and creators who want a step-change — not a cosmetic refresh.",
