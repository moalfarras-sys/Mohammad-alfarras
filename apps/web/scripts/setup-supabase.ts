...
async function main() {
  const migrationPaths = [
    ...
    path.resolve(process.cwd(), "../../supabase/migrations/003_drop_cms_tokens.sql"),
    path.resolve(process.cwd(), "../../supabase/migrations/004_contact_messages_and_lockdown.sql"),
    path.resolve(process.cwd(), "../../supabase/migrations/005_control_center_rebuild.sql"),
    path.resolve(process.cwd(), "../../supabase/migrations/006_app_ecosystem.sql"),
  ];
