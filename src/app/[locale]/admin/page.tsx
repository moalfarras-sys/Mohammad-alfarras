...
export default async function AdminPage({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(0,255,135,0.12),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(255,107,0,0.12),transparent_30%),linear-gradient(180deg,rgba(7,10,18,0.88),rgba(7,10,18,0.96))]" />
        ...
        <div className="rounded-[2.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.1),rgba(255,255,255,0.03)),rgba(7,10,18,0.86)] p-6 shadow-[0_30px_90px_rgba(0,0,0,0.4)] backdrop-blur-2xl md:p-8">
          <div className="mx-auto max-w-lg space-y-5">
            <div className="text-center lg:text-start">
              <div className="mx-auto mb-5 flex h-[4.5rem] w-[4.5rem] items-center justify-center overflow-hidden rounded-[1.7rem] border border-primary/25 bg-primary/10 shadow-[0_18px_50px_rgba(0,255,135,0.14)] lg:mx-0">
