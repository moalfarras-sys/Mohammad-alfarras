...
export const seoData = {
  en: {
    ...
    services: {
      ...
      description: "Web design, bilingual Arabic/English interfaces, product pages, UI/UX, and practical digital delivery.",
  ...
  ar: {
    ...
    services: {
      ...
      description: "تصميم وتطوير مواقع وواجهات عربية وإنجليزية وصفحات منتجات وتجارب UI/UX عملية.",
      image: "/images/service_web.png",
      keywords: [
        "تصميم مواقع",
        "تطوير مواقع",
