...
export function AdminHomeDashboard({ locale, snapshot }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="overflow-hidden rounded-[2rem] border border-primary/20 bg-[linear-gradient(135deg,rgba(91,124,255,0.1),rgba(244,184,96,0.07))] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.28)] backdrop-blur-2xl md:p-6">
