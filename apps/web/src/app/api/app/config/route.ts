...
const fallbackConfigs = {
  ...
  moplayer2: {
    ...
    update: {
      ...
      releaseNotes: "MoPlayer Pro 2.5.8 upgrades live playback with faster adaptive startup, stronger black-screen recovery, broader Media3/VLC format fallback, and safer handling for legacy IPTV and VOD containers.",
    },
