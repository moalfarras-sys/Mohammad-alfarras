...
const fallbackConfigs = {
  ...
  moplayer2: {
    ...
    maintenanceMode: false,
    forceUpdate: false,
    minimumVersionCode: 48,
    latestVersionName: "2.5.10",
    ...
    update: {
      ...
      apkSizeBytes: 49251400,
      checksumSha256: "fe35dab63d05266a719cd35521c1cbefb5ed45268795d878ae2da1c0ca0a70d1",
      releaseNotes: "MoPlayer Pro 2.5.10 starts live MPEG-TS channels faster, keeps manifest redirect probing in the background, and hardens LibVLC teardown to avoid native crashes during fallback playback and lifecycle changes.",
    },
