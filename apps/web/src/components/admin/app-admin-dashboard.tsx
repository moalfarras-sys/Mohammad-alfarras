    ...
    <div className="rounded-[1.5rem] border border-white/8 bg-black/15 p-4">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex flex-col gap-2">
          <Link
            href={`/api/app/releases/${item.slug}/download`}
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-7 text-foreground-muted">
              Product content, release packaging, screenshots, FAQs, and support requests now run from one protected Supabase-backed admin route.
            </p>
            <p className="text-xs text-foreground-soft">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/app" className="rounded-full border border-primary/25 px-4 py-3 text-sm font-bold text-primary">
              Open /app
            </Link>
