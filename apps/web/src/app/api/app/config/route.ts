...
const fallbackConfigs = {
  ...
  moplayer2: {
    ...
    update: {
      ...
      releaseNotes: "MoPlayer Pro 2.5.7 refreshes full IPTV libraries in the background, restores live/movie/series category content reliably, improves live preview art, and shortens weak-device live recovery so failed channels do not sit on a black loading screen.",
    },
