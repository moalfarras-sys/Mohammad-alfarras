        ...
        <div className="grid gap-5">
          <Card className="space-y-4">
            ...
            <div className="grid gap-3 md:grid-cols-4">
              <a className="rounded-[1.2rem] border border-[var(--os-border)] bg-white/[0.06] p-4 text-sm font-semibold text-[var(--os-text-1)] transition hover:border-[var(--brand-blue)]" href={`/${locale}/cv`} target="_blank" rel="noopener noreferrer">
                {t(locale, "معاينة صفحة CV", "Preview CV page")}
              </a>
              <a className="rounded-[1.2rem] border border-[var(--os-border)] bg-white/[0.06] p-4 text-sm font-semibold text-[var(--os-text-1)] transition hover:border-[var(--brand-blue)]" href={`/api/cv-pdf?locale=${locale}&variant=branded`} target="_blank" rel="noopener noreferrer">
                {t(locale, "تنزيل PDF مصمم", "Download designed PDF")}
              </a>
              <a className="rounded-[1.2rem] border border-[var(--os-border)] bg-white/[0.06] p-4 text-sm font-semibold text-[var(--os-text-1)] transition hover:border-[var(--brand-blue)]" href={`/api/cv-pdf?locale=${locale}&variant=ats`} target="_blank" rel="noopener noreferrer">
                {t(locale, "تنزيل PDF ATS", "Download ATS PDF")}
              </a>
              <a className="rounded-[1.2rem] border border-[var(--os-border)] bg-white/[0.06] p-4 text-sm font-semibold text-[var(--os-text-1)] transition hover:border-[var(--brand-blue)]" href={`/api/cv-docx?locale=${locale}`} target="_blank" rel="noopener noreferrer">
