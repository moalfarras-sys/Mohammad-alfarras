...
export const activationVisualCopy = {
  en: {
    ...
    activatedBody: "The TV is activated. MoPlayer will switch to Activated automatically and continue to Add Source.",
  ...
  ar: {
    ...
    title: "فعّل التلفزيون بكود قصير.",
    body:
      "يعرض MoPlayer كودًا من 4 خانات. أدخل الخانات الأربع فقط هنا؛ بادئة MO- ثابتة في الواجهة. بعد التفعيل يمكنك إرسال مصدر Xtream أو M3U بأمان إلى الجهاز المرتبط.",
    codeLabel: "كود الجهاز",
    placeholder: "4C7K",
    prefix: "MO-",
    check: "تفعيل",
    waiting: "بانتظار كود صحيح",
    invalid: "الكود غير صحيح",
    activated: "تم التفعيل",
    backendError: "خطأ في خدمة التفعيل",
    expired: "انتهت صلاحية الكود",
    waitingBody: "افتح MoPlayer على Android TV، اختر التفعيل عبر الموقع، ثم أدخل الخانات الأربع الظاهرة على الشاشة.",
    invalidBody: "استخدم أربع خانات مسموحة فقط. الأحرف O و0 وI و1 وS و5 محجوبة لتجنب الالتباس.",
    activatedBody: "تم تفعيل التلفزيون. سيتحول MoPlayer إلى Activated تلقائيًا ثم يكمل إلى Add Source.",
    backendErrorBody: "الخادم لم يؤكد الكود. حاول مرة أخرى بعد لحظات.",
    expiredBody: "الكود قصير المدة. أنشئ كودًا جديدًا من MoPlayer.",
    privacy: "يتم تشفير بيانات المزود على الخادم ولا يسحبها إلا جهاز MoPlayer المرتبط.",
    steps: ["افتح MoPlayer", "اختر Activate via Website", "امسح QR أو أدخل 4 خانات", "أكمل إلى Add Source"],
  },
} as const;
