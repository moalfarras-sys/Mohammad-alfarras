...
const videos = [
    ...
    { id: "H0nwbSawHF0", ar: "BYINTEK U4 | مراجعة بروجكتر بيونتيك يو 4", en: "BYINTEK U4 Projector – Full Review", views: "2,780", duration: "8:39", cat: "review" },
    { id: "CwFUXgMK01s", ar: "syncwire | ثبّت هاتفك بأمان مع سنكوير", en: "Syncwire – Secure Phone Holder", views: "91", duration: "3:29", cat: "unboxing" },
    { id: "dvZviJfHxu8", ar: "syncwire | أفضل ملحقات للسيارة بلوتوث 5.3", en: "Syncwire – Best Car Accessories Bluetooth 5.3", views: "1,392", duration: "3:56", cat: "unboxing" },
    { id: "NuwnE1-cb6Q", ar: "Oule GmbH Türklingel | جرس منزلي مميز", en: "Oule Smart Home Doorbell – Review", views: "182", duration: "3:57", cat: "smarthome" },
    ...
    { id: "McHuaqgwdG4", ar: "Amazon Alexa Echo Dot 4th Generation | كل ما تحتاج معرفتة", en: "Amazon Alexa Echo Dot 4th Gen – Full Guide", views: "77,904", duration: "12:00", cat: "review" },
...
const t = {
    ar: {
        ...
        filterLabel: "التصنيف",
        watchVideo: "شاهد",
        channelDesc: '"مرحباً، أنا محمد. كل ما تريد معرفته عن المنتجات التقنية — تجربة حقيقية، مراجعة صادقة، بدون مبالغة."',
    ...
    en: {
        ...
        filterLabel: "Filter",
        watchVideo: "Watch",
        channelDesc: '"Welcome, I\'m Mohammad. Everything you want to know about tech products — real experience, honest review, zero exaggeration."',
                ...
                <div className="container">
                    <div className="yt-hero-inner glass reveal-item">
                        ...
                        <div className="yt-hero-channel-card">
                            ...
                            <a href="https://www.youtube.com/@Moalfarras" target="_blank" rel="noreferrer noopener" className="btn secondary yt-channel-link">{tx.channelLink} →</a>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="yt-featured-card glass reveal-item">
                        ...
                        <div className="yt-featured-info">
                            <h2>{locale === "ar" ? "Amazon Alexa Echo Dot 4th Generation | كل ما تحتاج معرفتة" : "Amazon Alexa Echo Dot 4th Gen – Full Guide"}</h2>
