...
const fallbackConfigs = {
  ...
  moplayer2: {
    ...
    update: {
      ...
      apkSizeBytes: 49270231,
      checksumSha256: "cc863999acb220641943c87d1594a3c21974e1cd45e44c07cab0198b44321acc",
      releaseNotes:
        "MoPlayer Pro 2.5.22 rejects unauthorized Xtream logins before saving, keeps cached servers fast, hardens full-screen TV video sizing, and improves the in-player OK menu focus flow.",
    },
    ios: {
      enabled: true,
      status: "coming_soon",
